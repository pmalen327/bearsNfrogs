...
public class ExampleInClass extends JPanel implements ActionListener {
	...
	public ExampleInClass() {
		...
		// Load images
		try {
			plantImage = ImageIO.read(new File("src/a9/Animal-Icons/frog-icon.png"));
			zombieImage = ImageIO.read(new File("src/a9/Animal-Icons/chihuahua-icon.png"));
		} catch (IOException e) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		// Check if overlap between Zombie and Plant
		for (Actor actor : actors)
			for (Actor other : actors)
